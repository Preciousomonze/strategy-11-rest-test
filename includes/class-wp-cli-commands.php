...
class WP_CLI_Commands {
    ...
    public static function init() {
        if ( defined( 'WP_CLI' ) && WP_CLI ) {
            \WP_CLI::add_command( 'strategy11 refresh_data', [ __CLASS__, 'refresh_data' ] );
        }
    }
    ...
    public static function refresh_data() {
        ...
        if ( defined( 'WP_CLI' ) && WP_CLI ) {
            \WP_CLI::success( __( 'Data cache cleared. Data will be refreshed on the next request.', 'strategy-11-rest-test' ) );
        }
    }
}
